            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Premium Wash - James Wilson</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">This week (40 hr target)</p>
                </CardContent>
              </Card>
            </div>
                  ...
                  <TableBody>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Avatar className="h-8 w-8">
                            <AvatarImage src="/placeholder-user.jpg" alt="Robert Davis" />
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Avatar className="h-8 w-8">
                            <AvatarImage src="/placeholder-user.jpg" alt="Emily Brown" />
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Avatar className="h-8 w-8">
                            <AvatarImage src="/placeholder-user.jpg" alt="Michael Thompson" />
                ...
                <CardContent className="space-y-4">
                  <div className="rounded-lg border p-3">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      "Great service! My car looks brand new. Very thorough and professional."
                    </p>
                  </div>
                  <div className="rounded-lg border p-3">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      "Very happy with the interior cleaning. Prompt and efficient service."
                    </p>
                  </div>
                </CardContent>
              </Card>
