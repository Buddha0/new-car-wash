            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground">Tomorrow, 10:30 AM</p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-xl font-bold">$69.99</div>
                  <p className="text-sm text-muted-foreground">Deluxe Wash - May 15, 2023</p>
                </CardContent>
                <CardFooter>
                  <Button variant="outline" size="sm" className="w-full">
                    View Receipt
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Registered vehicles for service</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">White • License: ABC123</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    <Car className="h-10 w-10 text-primary" />
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Black • License: XYZ789</p>
                    </div>
                  </div>
                </CardContent>
                <CardFooter>
