...
// Service categories
const categories = ["All Categories", "exterior", "interior", "combo", "premium", "specialty"]
...
export default function AdminServices() {
  ...
  const sortedServices = [...filteredServices].sort((a, b) => parseFloat(b.price) - parseFloat(a.price))
  ...
  const handleUpdateService = async () => {
    try {
      ...
      // Filter out empty features
      const filteredFeatures = editService.features.filter(feature => feature.trim() !== "")
    ...
    <DashboardLayout userRole="admin">
      <div className="flex flex-col gap-4">
            ...
            <CardContent>
              {sortedServices.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">No services match your search criteria.</p>
                      ...
                      <TableBody>
                        {sortedServices.map((service) => (
                          <TableRow key={service.id}>
                            ...
                            <TableCell className="font-medium">${parseFloat(service.price).toFixed(2)}</TableCell>
                        ...
                        <CardContent className="p-0">
                          ...
                          <div className="border-t px-4 py-3 grid grid-cols-2 gap-2 text-sm">
                            <div>
                              ...
                              <div className="font-medium">${parseFloat(service.price).toFixed(2)}</div>
                            </div>
                            <div>
        ...
        {selectedService && !isEditDialogOpen && (
          <Dialog open={!!selectedService && !isEditDialogOpen} onOpenChange={() => setSelectedService(null)}>
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-auto">
              <DialogHeader>
                <DialogTitle>Service Details</DialogTitle>
                <DialogDescription>Service #{selectedService.id}</DialogDescription>
              </DialogHeader>
                ...
                <div>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {selectedService.features && selectedService.features.length > 0 ? (
                      ...
                      <li className="text-sm text-muted-foreground">No features added yet</li>
                    )}
                  </ul>
                </div>
              </div>
          ...
          <Dialog open={isEditDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-auto">
              <DialogHeader>
                ...
                <DialogDescription>Update service #{selectedService.id} details</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setEditService(prev => ({ ...prev, duration: e.target.value }))}
                    />
                  </div>
                </div>
